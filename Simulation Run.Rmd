...
Map the generating function over each paramter combination and repeat to output a list of assembled communities. Takes about 20 seconds per community on an average desktop. 1 example is included. 
...
Map the lag measuring function over the assemblies.
...
Map the Critical climate change rate function over the assemblies.
...
Map the peak sensitivity identifying function over the assemblies.
