...
Nodes are determined to be connected with a Gabriel algorithm (see figure above), that determines the closest node in each direction (`genAdjMat()` in `NetworkGenerators.R`).
