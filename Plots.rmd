...
GraphObject %>%
  ...
  geom_point( data = PopDens, aes( x = Node_X, y = ShiftedLine), 
...
A<- ggplot( R_Examples,aes(x = E))+
  ...
  ylim(-5, 12)+ylab( 'Growth Rate') +theme_minimal() +geom_vline( xintercept = opt) +
...
B<- ggplot( R_Examples,aes(x = E))+
  ...
  geom_line(aes(y= Rmat_plus1 ))+
  ylim(-5, 12)+ylab( 'Growth Rate')+theme_minimal()+
